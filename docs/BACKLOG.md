...
| [SH-47](tickets/SH-47-politique-dependances.md) | Politique de mise à jour des dépendances + Dependabot (8 entrées : npm ×2, pip, docker ×4, github-actions) + `pip-audit` bloquant en CI — *le `matching-service` était le seul service sans garde-fou sur ses dépendances* | 🟠 En cours | 2 | **C4.1.1**, C2.1.2, C2.2.3 | — |
