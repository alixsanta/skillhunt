...
| [SH-18a](tickets/SH-18a-portfolio-front.md) | Portfolio (front) : grille des cinq états, dépôt direct en trois temps avec progression réelle, carte du compte, section recruteur — *lecteur HLS et visionneuse 360° reportés en SH-18b, ils dépendent des routes de lecture de SH-17* | 🟠 En cours | 3 | C2.4.1, C2.2.2, C2.1.2 | — |
