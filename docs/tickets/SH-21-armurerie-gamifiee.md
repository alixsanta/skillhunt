...
- **SH-21c — Loadout, progression/XP, badges** (~5 SP) : **cadrée le 2026-07-17** — design validé dans [`docs/superpowers/specs/2026-07-17-armurerie-gamification-design.md`](../superpowers/specs/2026-07-17-armurerie-gamification-design.md) (XP dérivé à la lecture — barème 50/30/80, 6 niveaux Recrue→Légende, 7 badges dérivés, loadout 4 slots `VALIDATED` uniquement via `gear.isInLoadout` + `PATCH /gear/:id/loadout`, vue recruteur réduite niveau+badges obtenus). Branche `feature/SH-21c-armurerie-gamification`.
